...
// fmt — formats a number as GBP (£) by default, which is the primary currency for this app.
// For display of other currencies use fmtCurrency(amount, currency) explicitly.
...
export const PLATFORMS = [
  'StubHub', 'Viagogo', 'Tixstock', 'Lysted',
